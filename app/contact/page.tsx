...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("sent");
      setForm({ name: "", email: "", service: "Full stack web development", message: "" });
    } catch (err) {
          ...
          <div className="card" data-reveal>
            ...
            {status === "sent" ? (
              <div className="form">
                ...
                <p className="muted">Thanks for reaching out — I'll get back to you within 24 hours.</p>
              ...
              <form className="form" ref={formRef} onSubmit={handleSubmit} noValidate>
                ...
                {status === "error" && (
                  <div className="error is-visible" role="alert">
